        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinDiscountAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DiscountCodes_AppUser_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUser",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Possiton = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Gender = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DateOfBirth = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Emloyees_AppUser_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUser",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImportReceipt_AppUser_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUser",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThumbnaiUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Note = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TotalDelt = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentToSuppliers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PaymentToSuppliers_AppUser_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUser",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PaymentToSuppliers_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppliedValue = table.Column<decimal>(type: "deciaml(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDiscounts", x => new { x.OrderId, x.DiscountCodeId });
                    table.ForeignKey(
                        name: "FK_OrderDiscounts_DiscountCodes_DiscountCodeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PoductVariantId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImportReceiptDetails_ImportReceipt_ImportReceiptId",
                        column: x => x.ImportReceiptId,
                        principalTable: "ImportReceipt",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ImportReceiptDetails_ProductVariants_ProductVariantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    UnPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Emloyees_AppUserId",
                table: "Emloyees",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ImportReceipt_AppUserId",
                table: "ImportReceipt",
                column: "AppUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImportReceiptDetails_ProductVariantId",
                table: "ImportReceiptDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDiscounts_DiscountCodeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentToSuppliers_AppUserId",
                table: "PaymentToSuppliers",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentToSuppliers_SupplierId",
                table: "PaymentToSuppliers",
                column: "SupplierId");
